          ...
          final textColumn = Column(
            ...
            children: [
              ...
              ConstrainedBox(
                ...
                child: Text(
                  'Import CSV or XLSX files, calculate grades, export to multiple formats, and share the final report from one delivery center.',
              ...
              Wrap(
                ...
                children: const [
                  ...
                  _HeroPill(title: 'Output', value: 'Excel, PDF, JSON, CSV, Word'),
                  _HeroPill(title: 'Share', value: 'Local, cloud, and system share'),
                ],
              ),
            ],
          );
          ...
          final spotlight = Container(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  'The delivery layer now uses interfaces, abstract exporters, and a factory so new services can be added or removed without rewriting the grading engine.',
                ...
                const _HeroMetric(
                  label: 'Patterns',
                  value: 'Interfaces, factory, abstract exporters',
                ),
                const SizedBox(height: 10),
                const _HeroMetric(
                  label: 'Delivery',
                  value: 'Local files, cloud folders, share actions',
                ),
              ],
            ),
          );
