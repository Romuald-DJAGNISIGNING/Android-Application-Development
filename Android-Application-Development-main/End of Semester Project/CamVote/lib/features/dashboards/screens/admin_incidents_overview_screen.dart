...
class AdminIncidentsOverviewScreen extends ConsumerWidget {
  const AdminIncidentsOverviewScreen({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final filter = ref.watch(adminIncidentFilterProvider);
    final incidents = ref.watch(adminIncidentsProvider(filter));
    final t = AppLocalizations.of(context);

    return Scaffold(
      appBar: NotificationAppBar(title: Text(t.adminIncidentsTitle)),
      body: BrandBackdrop(
            ...
            children: [
              CamStagger(
                children: [
                  ...
                  BrandHeader(
                    title: t.adminIncidentsTitle,
                    subtitle: t.adminIncidentsSubtitle,
                  ),
